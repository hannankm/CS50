...
void sort_pairs(void)
{
    ...
    for (int i = 0; i < pair_count - 1; i++)
    {
        ...
        for (int j = i + 1; j < pair_count; j++)
        {
            ...
            {
                winner_index = pairs[j].winner;
                loser_index = pairs[j].loser;
                index = j;
                swap = 1;
            }
        }
        ...
        if (swap == 1)
        {
            ...
            pairs[i].winner = winner_index;
            pairs[index].winner = temp;

            temp = pairs[i].loser;
            pairs[i].loser = loser_index;
            pairs[index].loser = temp;
        }
    }
    return;
}
...
// record incoming edges for each candidate
    for (int i = 0; i < candidate_count; i++)
    {
        for (int j = 0; j < candidate_count; j++)
        {
